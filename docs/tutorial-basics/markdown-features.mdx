...
You can use absolute paths to reference images in the static directory (`static/img/ai-robotics.png`):

```md
![AI Robotics logo](pathname:///img/ai-robotics.png)
```
...
```md
![AI Robotics logo](./img/ai-robotics.png)
```
